...
import type { ExternalBlob as _ExternalBlob, Image as _Image, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addLeaderboardEntry(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addLeaderboardEntry(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllImageMetadata(): Promise<Array<Image>> {
        if (this.processError) {
            try {
    ...
    async getAllImages(): Promise<Array<ApiResponse>> {
        if (this.processError) {
            try {
    ...
    async getCounter(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getCounter();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getImageMetadata(arg0: string): Promise<Image | null> {
        if (this.processError) {
            try {
    ...
    async getLeaderboard(): Promise<Array<Entry>> {
        if (this.processError) {
            try {
    ...
    async incrementAndGetCounter(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.incrementAndGetCounter();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async testJsonResponse(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.testJsonResponse();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadImage(arg0: string, arg1: string, arg2: ExternalBlob): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadImage(arg0, arg1, await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Image]): Promise<Image | null> {
    return value.length === 0 ? null : await from_candid_Image_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Image>): Promise<Array<Image>> {
